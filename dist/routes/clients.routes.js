...
import { addClient, deleteClient, editClient, getClient, getClients, } from '../controllers/index.js';
...
clientRoutes.put('/:clientId', requireAuth, param('clientId', ':clientId is required variable in path').notEmpty(), checkSchema(clientSchema), editClient);
clientRoutes.get('/:clientId', requireAuth, param('clientId', 'clientId is required variable in path').notEmpty(), getClient);
clientRoutes.delete('/:clientId', requireAuth, param('clientId', 'clientId is required variable in path').notEmpty(), deleteClient);
export { clientRoutes };
